...
| Phosphor Icons | 6 种粗细变体，统一风格 | [phosphoricons.com](https://phosphoricons.com) |
| Tabler Icons | 5000+ 开源 SVG 图标 | [tabler.io/icons](https://tabler.io/icons) |
| 3dicons | 开源 3D 风格图标 | [3dicons.co](https://3dicons.co) |
...
| Drawkit | 手绘风 + 扁平风插画 | [drawkit.com](https://www.drawkit.com) |
...
| 图片库 | 特点 | 地址 |
|--------|------|------|
| Pexels | 免费高质量摄影图+视频，中文搜索友好 | [pexels.com/zh-cn](https://www.pexels.com/zh-cn/) |
| Unsplash | 最大的免费摄影图库 | [unsplash.com](https://unsplash.com) |
| Pixabay | 图片+矢量图+视频 | [pixabay.com](https://pixabay.com) |
...
除了静态规则文件，还可以通过 MCP（Model Context Protocol）让 AI 实时访问外部设计资源：
...
```json
{
  "mcpServers": {
    "21st-magic": {
      ...
      "env": {
        "TWENTY_FIRST_API_KEY": "你的21st.dev API Key"
      }
    },
    "context7": {
      "command": "npx",
...
**效果**：AI 在编码时会实时查询 21st.dev 的专业 UI 组件库和最新文档，产出更专业的组件代码。
