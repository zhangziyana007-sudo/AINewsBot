...
| 平台 | 特点 | 地址 |
|------|------|------|
| 花瓣网 | 国内最大设计灵感平台，中文搜索，采集功能强 | [huaban.com](https://huaban.com) |
| 站酷 | 国内设计师社区，优秀网页/UI/品牌作品集 | [zcool.com.cn](https://www.zcool.com.cn) |
| UI 中国 | 国内 UI 设计社区，大厂设计师作品 | [ui.cn](https://www.ui.cn) |
| 优设 | 设计师学习平台，灵感+教程+资源 | [uisdc.com](https://www.uisdc.com) |
| Dribbble | 全球高质量 UI 设计稿灵感 | [dribbble.com](https://dribbble.com) |
...
| 设计达人 | 国内设计博客，网页设计灵感精选 | [shejidaren.com](https://www.shejidaren.com) |

#### 移动端 UI 设计参考

| 平台 | 特点 | 地址 |
|------|------|------|
| Mobbin | 全球最大移动端 UI 模式库，按功能分类截图 | [mobbin.com](https://mobbin.com) |
| 集创堂 | 国内 App UI 截图收集，按类别/风格浏览 | [uitrend.com](https://uitrend.com) |
| 美叶 | 国内设计灵感平台，App/小程序/H5 截图丰富 | [meiye.art](https://meiye.art) |
| Screenlane | 移动端 UI 交互录屏，可按组件/模式筛选 | [screenlane.com](https://screenlane.com) |
| Pttrns | iOS/Android 界面设计模式库 | [pttrns.com](https://pttrns.com) |
| 设计导航 | 优设旗下导航站，聚合 App 截图和 UI 资源 | [hao.uisdc.com](https://hao.uisdc.com) |
...
| 工具 | 类型 | 用法 |
|------|------|------|
| [即时设计](https://js.design) | 国内 Figma 替代，免费在线设计工具 | 中文界面，团队协作，直接导出代码 |
| [MasterGo](https://mastergo.com) | 国产在线设计工具 | 类 Figma，中文优化，支持设计系统 |
| [Pixso](https://pixso.cn) | 国产协同设计平台 | AI 生成设计稿 + 原型 + 交付，中文友好 |
| [Figma](https://figma.com) | 全球最流行的设计工具 | 手动或AI辅助设计 → 通过 MCP 交给编程工具 |
...
**移动端插画注意**：
- App 空状态、引导页、权限申请页必须配插画，unDraw/Storyset 同样适用
- 移动端插画尺寸控制在 `max-width: 240px`，比 Web 端更小
- 启动页/闪屏插画建议使用 Storyset 动态插画增加品牌感
...
**移动端图片注意**：
```
移动端头图建议 aspect-ratio: 3/4 或 1/1，竖屏更友好。
列表缩略图统一正方形 1:1 比例，圆角 8px。
头像统一 border-radius: 50%，尺寸 40-48px。
移动端图片优先用 WebP 格式，减少流量消耗。
懒加载 (loading="lazy") 在移动端尤为重要。
```
...
移动端占位图使用竖版尺寸：https://picsum.photos/375/500（3:4比例）。
```
...
| 工具 | 用途 | 地址 |
|------|------|------|
| 中国色 | 中国传统色彩方案，古风/国潮首选 | [zhongguose.com](http://zhongguose.com) |
| 日本色 | 日系传统色彩，淡雅柔和 | [nipponcolors.com](https://nipponcolors.com) |
| Color Hunt | 精选配色方案集合，按热度/随机浏览 | [colorhunt.co](https://colorhunt.co) |
| Coolors | 随机生成和谐配色方案 | [coolors.co](https://coolors.co) |
| Realtime Colors | 实时预览配色在网页上的效果 | [realtimecolors.com](https://realtimecolors.com) |
| 渐变色方案集合 | WebGradients — 180个漂亮渐变 | [webgradients.com](https://webgradients.com) |
